...
dumb_luck = gubernator.songs.create(title: "Dumb Luck", played_count: Random.rand(1000), artist_id: 1)
dumb_luck.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/dumb_luck.mp3"), filename: "dumb_luck.mp3")
helmsman = gubernator.songs.create(title: "Helmsman", played_count: Random.rand(1000), artist_id: 1)
helmsman.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/helmsman.mp3"), filename: "helmsman.mp3")
crimea = gubernator.songs.create(title: "Crimea", played_count: Random.rand(1000), artist_id: 1)
crimea.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/crimea.mp3"), filename: "crimea.mp3")
traitors_gate = gubernator.songs.create(title: "Traitors Gate", played_count: Random.rand(1000), artist_id: 1)
...
big_drop = the_great_bear.songs.create(title: "Big Drop", played_count: Random.rand(1000), artist_id: 1)
big_drop.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/big_drop.mp3"), filename: "big_drop.mp3")
four_am = the_great_bear.songs.create(title: "4am", played_count: Random.rand(1000), artist_id: 1)
four_am.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/4_am.mp3"), filename: "4_am.mp3")
waiting = the_great_bear.songs.create(title: "Waiting", played_count: Random.rand(1000), artist_id: 1)
...
via_laietana = barcelona.songs.create(title: "Via Laietana", played_count: Random.rand(1000), artist_id: 2)
via_laietana.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/via_laietana.mp3"), filename: "via_laietana.mp3")
passeig_de_gracia = barcelona.songs.create(title: "Passeig de Gràcia", played_count: Random.rand(1000), artist_id: 2)
...
itaca = barcelona.songs.create(title: "Itaca", played_count: Random.rand(1000), artist_id: 2)
...
everything_zen_music = everything_zen.songs.create(title: "Everything Zen", played_count: Random.rand(1000), artist_id: 2)
everything_zen_music.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/everything_zen.mp3"), filename: "everything_zen.mp3")

N_files/musics/malvinas_go_go.mp3"), filename: "malvinas_go_go.mp3")
coronation_pope_francis = meng_jia.songs.create(title: "Coronation of Pope Francis", played_count: Random.rand(1000), artist_id: 2)
...
wobbly_way = mystery_club.songs.create(title: "Wobbly Way", played_count: Random.rand(1000), artist_id: 3)
wobbly_way.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/wobbly_way.mp3"), filename: "wobbly_way.mp3")
very_hazel = mystery_club.songs.create(title: "Very Hazel", played_count: Random.rand(1000), artist_id: 3)
very_hazel.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/very_hazel.mp3"), filename: "very_hazel.mp3")
favorite_secrets = mystery_club.songs.create(title: "Favorite Secrets", played_count: Random.rand(1000), artist_id: 3)
...
how_can_i_love_her = covers_besides.songs.create(title: "How can I love her", played_count: Random.rand(1000), artist_id: 4)
...
save_my_soul = be_love_not_fear.songs.create(title: "Save my Soul", played_count: Random.rand(1000), artist_id: 5)
save_my_soul.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/save_my_soul.mp3"), filename: "save_my_soul.mp3")
who_am_i = be_love_not_fear.songs.create(title: "Who am I?", played_count: Random.rand(1000), artist_id: 5)
who_am_i.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/who_am_i.mp3"), filename: "who_am_i.mp3")
jane_the_ripper = be_love_not_fear.songs.create(title: "Jane the Ripper", played_count: Random.rand(1000), artist_id: 5)
...
freed_from_greed = trinity.songs.create(title: "Freed from Greed", played_count: Random.rand(1000), artist_id: 5)
freed_from_greed.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/freed_from_greed.mp3"), filename: "freed_from_greed.mp3")
aisling = trinity.songs.create(title: "Aisling", played_count: Random.rand(1000), artist_id: 5)
...
junkie = paw_paw_tree.songs.create(title: "Junkie", played_count: Random.rand(1000), artist_id: 6)
junkie.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/junkie.mp3"), filename: "junkie.mp3")
fighting_a_mountain = paw_paw_tree.songs.create(title: "Fighting a Mountain", played_count: Random.rand(1000), artist_id: 6)
...
wanderin_eyes = paw_paw_tree.songs.create(title: "Wanderin' Eyes", played_count: Random.rand(1000), artist_id: 6)
wanderin_eyes.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/wanderin_eyes.mp3"), filename: "wanderin_eyes.mp3")
human_hands = paw_paw_tree.songs.create(title: "Human Hands", played_count: Random.rand(1000), artist_id: 6)
human_hands.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/human_hands.mp3"), filename: "human_hands.mp3")
coffee_chocolate_earth = paw_paw_tree.songs.create(title: "Coffee, Chocolate, Earth", played_count: Random.rand(1000), artist_id: 6)
...
lazy = years_and_years_ago.songs.create(title: "Lazy", played_count: Random.rand(1000), artist_id: 7)
lazy.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/lazy.mp3"), filename: "lazy.mp3")
snow = years_and_years_ago.songs.create(title: "Snow", played_count: Random.rand(1000), artist_id: 7)
snow.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/snow.mp3"), filename: "snow.mp3")
grief = years_and_years_ago.songs.create(title: "Grief", played_count: Random.rand(1000), artist_id: 7)
grief.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/grief.mp3"), filename: "grief.mp3")
clowns = years_and_years_ago.songs.create(title: "Clowns", played_count: Random.rand(1000), artist_id: 7)
...
life = mans_life.songs.create(title: "Life", played_count: Random.rand(1000), artist_id: 7)
life.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/life.mp3"), filename: "life.mp3")
death_redemption = mans_life.songs.create(title: "Death & Redemption", played_count: Random.rand(1000), artist_id: 7)
...
antares, = aldebaran.songs.create(title: "Antares", played_count: Random.rand(1000), artist_id: 7)
...
ivy = inside.songs.create(title: "Ivy", played_count: Random.rand(1000), artist_id: 8)
ivy.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/ivy.mp3"), filename: "ivy.mp3")
escape = inside.songs.create(title: "Escape", played_count: Random.rand(1000), artist_id: 8)
...
dizzy = User.create(name: "Dizzy", email: "dizzy@fantasy.com", password: "123456", password_confirmation: "123456")
dizzy.favorites.create(favoritable: trinity)
dizzy.favorites.create(favoritable: paw_paw_tree)
dizzy.favorites.create(favoritable: everything_zen)
dizzy.favorites.create(favoritable: gubernator)
dizzy.recently_heards.create(album: inside)
dizzy.recently_heards.create(album: trinity)
dizzy.recently_heards.create(album: gubernator)
dizzy.recently_heards.create(album: the_great_bear)